...
echo "rs.add('45.56.85.129:27048')" >> authentication.js
echo "sleep(1000)" >> authentication.js
echo "rs.addArb('45.56.85.129:27049')" >> authentication.js
echo "sleep(1000)" >> authentication.js
echo "rs.status()" >> authentication.js
echo "cfg = rs.conf()" >> authentication.js
echo "cfg.members[0].host = '45.56.85.129:27047'" >> authentication.js
